...
then
    ...
    TVM_VERSION=9.0.0
    CGT_ARMLLVM_VERSION=2.1.2.LTS
    CGT_C7X_VERSION=4.1.0.LTS
    SYSCONFIG_BUILD=4712
    SYSCONFIG_VERSION=1.28.0
    GCC_ARCH64_VERSION=15.2.rel1
    ...
    if [ -d ${PSDK_TOOLS_PATH}/ti-cgt-armllvm_${CGT_ARMLLVM_VERSION} ]; then
        ...
        #wget --tries=5 https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-ayxs93eZNN/2.1.2.LTS/ti_cgt_armllvm_2.1.2.LTS_linux-x64_installer.bin -P ${PSDK_TOOLS_PATH} --no-check-certificate
        chmod +x ${PSDK_TOOLS_PATH}/ti_cgt_armllvm_${CGT_ARMLLVM_VERSION}_linux-x64_installer.bin
        ${PSDK_TOOLS_PATH}/ti_cgt_armllvm_${CGT_ARMLLVM_VERSION}_linux-x64_installer.bin  ${PSDK_TOOLS_PATH}
    ...
    then
        ...
        if [ -d ${PSDK_TOOLS_PATH}/ti-cgt-c6000_${CGT_C6X_VERSION} ]; then
            ...
            ${PSDK_TOOLS_PATH}/ti_cgt_c6000_${CGT_C6X_VERSION}_linux_installer_x86.bin --mode unattende--mode unattended --prefixd --prefix ${PSDK_TOOLS_PATH}
    ...
    if [ $firmware_only -eq 0 ]
    then
        echo "[arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf] Checking ..."
        if [ -d ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf ]; then
            echo "${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf found!"
        else
            ...
            wget --tries=5 https://armkeil.blob.core.windows.net/developer/files/downloads/gnu/${GCC_ARCH64_VERSION}/binrel/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf.tar.xz -P ${PSDK_TOOLS_PATH} --no-check-certificate
            tar xf ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf.tar.xz -C ${PSDK_TOOLS_PATH} > /dev/null
            rm ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf.tar.xz
        fi
        echo "[arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-aarch64-none-elf] Done"

        echo "[arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf] Checking ..."
        if [ -d ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf ]; then
            echo "${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf found!"
        else
            ...
            wget --tries=5 https://armkeil.blob.core.windows.net/developer/files/downloads/gnu/${GCC_ARCH64_VERSION}/binrel/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf.tar.xz -P ${PSDK_TOOLS_PATH} --no-check-certificate
            tar xf ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf.tar.xz -C ${PSDK_TOOLS_PATH} > /dev/null
            rm ${PSDK_TOOLS_PATH}/arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf.tar.xz
        fi
        echo "[arm-gnu-toolchain-${GCC_ARCH64_VERSION}-x86_64-arm-none-linux-gnueabihf] Done"
    fi
